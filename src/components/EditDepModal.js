...
export class EditDepModal extends Component {
    ...
    handleSubmit(e){
        e.preventDefault();
        fetch('http://localhost:53301/api/department',{method:'PUT',headers:{"Access-Control-Allow-Origin": "http://localhost:53301/api/department",'Accept':'application/json','Content-Type':'application/json'},
        body:JSON.stringify({
